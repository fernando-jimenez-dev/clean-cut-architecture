...
> [!WARNING]
> This templates are a **work in progress** and its currently in version `0.5.0-beta`. Expect incomplete sections, evolving content, and potential changes in structure. Feedback and suggestions are welcome as we refine the material.
