...
<p align="center">0.5.0-beta</p>

---

> [!WARNING]
> This documentation is a **work in progress** and its currently in version `0.5.0-beta`. Expect incomplete sections, evolving content, and potential changes in structure. We are actively working on completing the core chapters and refining the examples. Feedback and suggestions are welcome as we refine the material.
